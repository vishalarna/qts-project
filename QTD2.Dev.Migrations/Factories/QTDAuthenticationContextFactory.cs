...
{
    public class QTDAuthenticationContextFactory : IDesignTimeDbContextFactory<QTDAuthenticationContext>
    {
        public QTDAuthenticationContext CreateDbContext(string[] args)
        {
            ...
            var optionsBuilder = new DbContextOptionsBuilder<QTDAuthenticationContext>();
            ...
            return new QTDAuthenticationContext(optionsBuilder.Options);
        }
    }
}
