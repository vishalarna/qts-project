...
namespace QTD2.Domain.Interfaces.Service.Core
{
    public interface ISkillQualificationService : Common.IService<SkillQualification>
    {
        ...
        System.Threading.Tasks.Task<List<SkillQualification>> GetPendingSkillQualificationsListAsTraineeByEmpId(int employeeId);
        Task<List<SkillQualification>> GetCompletedSkillQualificationsListAsEvalByEmpId(int employeeId);
        Task<List<SkillQualification>> GetCompletedSkillQualificationsListAsTraineeByEmpId(int employeeId);
        Task<List<SkillQualification>> GetBySkillQualificationIDAsync(int id);
