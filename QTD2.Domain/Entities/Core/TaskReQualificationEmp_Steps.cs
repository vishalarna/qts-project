...
{
    public class TaskReQualificationEmp_Steps : Common.Entity
    {
        ...
        public TaskReQualificationEmp_Steps(int taskQualificationId, int tasktepId, string comments, int evaluatorId, DateTime commentDate, int traineeId, bool isCompleted)
        {

            TaskQualificationId = taskQualificationId;
            TaskStepId = tasktepId;
            Comments = comments;
        ...
        public TaskReQualificationEmp_Steps()
        {
