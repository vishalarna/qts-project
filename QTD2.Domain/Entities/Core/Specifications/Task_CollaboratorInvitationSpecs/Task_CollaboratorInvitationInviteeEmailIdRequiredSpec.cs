...
{
    public class Task_CollaboratorInvitationInviteeEmailIdRequiredSpec : ISpecification<Task_CollaboratorInvitation>
    {
        public bool IsSatisfiedBy(Task_CollaboratorInvitation entity, params object[] args)
        {
            return !string.IsNullOrEmpty(entity.InviteeEmail);
        }
    }
}
