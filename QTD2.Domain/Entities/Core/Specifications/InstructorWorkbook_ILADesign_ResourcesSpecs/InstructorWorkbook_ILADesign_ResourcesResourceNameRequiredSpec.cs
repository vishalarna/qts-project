...
{
   public class InstructorWorkbook_ILADesign_ResourcesResourceNameRequiredSpec : ISpecification<InstructorWorkbook_ILADesign_Resources>
    {
        public bool IsSatisfiedBy(InstructorWorkbook_ILADesign_Resources entity, params object[] args)
        {
            return !string.IsNullOrEmpty(entity.ResourceName);
        }
    }
}
