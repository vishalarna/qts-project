...
{
    class InstructorWorkbook_ILADesign_SegmentsSegmentTextRequiredSpec : ISpecification<InstructorWorkbook_ILADesign_Segments>
    {
        public bool IsSatisfiedBy(InstructorWorkbook_ILADesign_Segments entity, params object[] args)
        {
            return !string.IsNullOrEmpty(entity.SegmentText);
        }
    }
}
