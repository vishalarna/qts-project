...
{
   public class InstructorWorkbook_ILAEvaluationEvaluationResultRequiredspec : ISpecification<InstructorWorkbook_ILAEvaluation>
    {
        public bool IsSatisfiedBy(InstructorWorkbook_ILAEvaluation entity, params object[] args)
        {
            return !string.IsNullOrEmpty(entity.EvaluationResult);
        }
    }
}
