...
{
   public class InstructorWorkbook_ILAEvaluationLevel2StatusRequiredSpec : ISpecification<InstructorWorkbook_ILAEvaluation>
    {
        public bool IsSatisfiedBy(InstructorWorkbook_ILAEvaluation entity, params object[] args)
        {
            return !string.IsNullOrEmpty(entity.Level2Status);
        }
    }
}
