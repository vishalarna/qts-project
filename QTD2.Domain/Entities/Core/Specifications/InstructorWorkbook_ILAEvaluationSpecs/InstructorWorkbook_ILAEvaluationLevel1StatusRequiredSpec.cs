...
{
   public class InstructorWorkbook_ILAEvaluationLevel1StatusRequiredSpec : ISpecification<InstructorWorkbook_ILAEvaluation>
    {
        public bool IsSatisfiedBy(InstructorWorkbook_ILAEvaluation entity, params object[] args)
        {
            return !string.IsNullOrEmpty(entity.Level1Status);
        }
    }
}
