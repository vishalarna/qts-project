...
{
    public class CSE_ILACertLink_SubReq_PartialCredit_ILASubReqLinkIdRequiredSpec : ISpecification<ClassScheduleEmployee_ILACertificationLink_SubRequirement_PartialCredit>
    {
        ...
        {
            return entity.ILACertificationSubRequirementLinkId > 0;
        }
    }
}
