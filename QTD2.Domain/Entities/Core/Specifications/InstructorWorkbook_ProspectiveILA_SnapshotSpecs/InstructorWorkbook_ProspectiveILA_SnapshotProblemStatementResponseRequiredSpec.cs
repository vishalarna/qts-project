...
{
    public class InstructorWorkbook_ProspectiveILA_SnapshotProblemStatementResponseRequiredSpec : ISpecification<InstructorWorkbook_ProspectiveILA_Snapshot>
    {
        public bool IsSatisfiedBy(InstructorWorkbook_ProspectiveILA_Snapshot entity, params object[] args)
        {
            return entity.ChangedBy > 0;
        }
    }
}
