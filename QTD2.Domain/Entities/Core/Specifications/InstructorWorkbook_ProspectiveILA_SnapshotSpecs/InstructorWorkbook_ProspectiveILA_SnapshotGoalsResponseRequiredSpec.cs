...
{
    public class InstructorWorkbook_ProspectiveILA_SnapshotGoalsResponseRequiredSpec : ISpecification<InstructorWorkbook_ProspectiveILA_Snapshot>
    {
        public bool IsSatisfiedBy(InstructorWorkbook_ProspectiveILA_Snapshot entity, params object[] args)
        {
            return !string.IsNullOrEmpty(entity.GoalsResponse);
        }
    }
}
