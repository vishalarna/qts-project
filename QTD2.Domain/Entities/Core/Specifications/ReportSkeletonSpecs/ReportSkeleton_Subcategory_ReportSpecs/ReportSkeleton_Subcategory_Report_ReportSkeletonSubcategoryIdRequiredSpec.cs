...
{
    public class ReportSkeleton_Subcategory_Report_ReportSkeletonSubcategoryIdRequiredSpec : ISpecification<QTD2.Domain.Entities.Core.ReportSkeleton_Subcategory_Report>
    {
