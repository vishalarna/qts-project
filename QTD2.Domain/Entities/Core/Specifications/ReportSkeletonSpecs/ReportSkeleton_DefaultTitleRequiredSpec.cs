...
{
    public class ReportSkeleton_DefaultTitleRequiredSpec : ISpecification<QTD2.Domain.Entities.Core.ReportSkeleton>
    {
        public bool IsSatisfiedBy(QTD2.Domain.Entities.Core.ReportSkeleton entity, params object[] args)
        {
            return !string.IsNullOrEmpty(entity.DefaultTitle);
        }
    }
}
