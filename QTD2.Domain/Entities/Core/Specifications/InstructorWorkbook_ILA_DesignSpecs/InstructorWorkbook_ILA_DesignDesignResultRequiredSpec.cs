...
{
   public class InstructorWorkbook_ILA_DesignDesignResultRequiredSpec : ISpecification<InstructorWorkbook_ILA_Design>
    {
        public bool IsSatisfiedBy(InstructorWorkbook_ILA_Design entity, params object[] args)
        {
            return !string.IsNullOrEmpty(entity.DesignResult);
        }
    }
}
