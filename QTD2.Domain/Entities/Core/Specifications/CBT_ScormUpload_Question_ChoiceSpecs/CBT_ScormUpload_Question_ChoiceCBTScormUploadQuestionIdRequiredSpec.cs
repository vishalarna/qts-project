...
{
    public class CBT_ScormUpload_Question_ChoiceCBTScormUploadQuestionIdRequiredSpec : ISpecification<CBT_ScormUpload_Question_Choice>
    {
        public bool IsSatisfiedBy(CBT_ScormUpload_Question_Choice entity, params object[] args)
        {
            return entity.CBTScormUploadQuestionId > 0;
        }
    }
}