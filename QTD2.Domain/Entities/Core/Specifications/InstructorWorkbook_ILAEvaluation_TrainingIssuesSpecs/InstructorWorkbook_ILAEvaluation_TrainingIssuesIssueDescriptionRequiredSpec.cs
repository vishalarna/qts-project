...
{
    public class InstructorWorkbook_ILAEvaluation_TrainingIssuesIssueDescriptionRequiredSpec : ISpecification<InstructorWorkbook_ILAEvaluation_TrainingIssues>
    {
        public bool IsSatisfiedBy(InstructorWorkbook_ILAEvaluation_TrainingIssues entity, params object[] args)
        {
            return !string.IsNullOrEmpty(entity.IssueDescription);
        }
    }
}
