...
{
    public class TrainingIssue_ActionItem_ActionItemNameRequiredSpec : ISpecification<TrainingIssue_ActionItem>
    {
        public bool IsSatisfiedBy(TrainingIssue_ActionItem entity, params object[] args)
        {
            return !string.IsNullOrEmpty(entity.ActionItemName);
        }
    }
}
