...
{
  public  class InstructorWorkbook_ProspectiveILAResultRequiredSpec : ISpecification<InstructorWorkbook_ProspectiveILA>
    {
        public bool IsSatisfiedBy(InstructorWorkbook_ProspectiveILA entity, params object[] args)
        {
            return !string.IsNullOrEmpty(entity.Result);
        }
    }
