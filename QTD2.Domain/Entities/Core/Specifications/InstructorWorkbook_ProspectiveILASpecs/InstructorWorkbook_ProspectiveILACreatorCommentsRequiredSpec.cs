...
{
  public class InstructorWorkbook_ProspectiveILACreatorCommentsRequiredSpec : ISpecification<InstructorWorkbook_ProspectiveILA>
    {
        public bool IsSatisfiedBy(InstructorWorkbook_ProspectiveILA entity, params object[] args)
        {
            return !string.IsNullOrEmpty(entity.CreatorComments);
        }
    }
}
