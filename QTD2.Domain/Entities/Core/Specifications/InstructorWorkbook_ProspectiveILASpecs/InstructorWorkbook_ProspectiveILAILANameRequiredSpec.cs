...
{
    public class InstructorWorkbook_ProspectiveILAILANameRequiredSpec : ISpecification<InstructorWorkbook_ProspectiveILA>
    {
        public bool IsSatisfiedBy(InstructorWorkbook_ProspectiveILA entity, params object[] args)
        {
            return !string.IsNullOrEmpty(entity.ILAName);
        }
    }
}
