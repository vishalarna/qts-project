...
{
    public class ClassSchedule_Roster_TimeRecordStartDateTimeRequiredSpec : ISpecification<ClassSchedule_Roster_TimeRecord>
    {
        public bool IsSatisfiedBy(ClassSchedule_Roster_TimeRecord entity, params object[] args)
        {
            return entity.StartDateTime != DateTime.MaxValue;
        }
    }
}