...
{
   public class ClassSchedule_Roster_TimeRecordClassSchedule_RosterIdRequiredSpec : ISpecification<ClassSchedule_Roster_TimeRecord>
    {
        public bool IsSatisfiedBy(ClassSchedule_Roster_TimeRecord entity, params object[] args)
        {
            return entity.ClassSchedule_RosterId > 0;
        }
    }
}
