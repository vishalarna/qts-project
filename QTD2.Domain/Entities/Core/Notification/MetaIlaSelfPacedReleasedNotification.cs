...
{
    public class MetaIlaSelfPacedReleasedNotification : Notification
    {
        ...
        public MetaIlaSelfPacedReleasedNotification() { }

        public MetaIlaSelfPacedReleasedNotification(DateTime dueDate, int? metaILA_Employee_MemberLinkFufillmentId, int nextMeta_ILAMembers_LinkId, int employeeId, int toPerson, int clientSettings_NotificationStepId) : base(dueDate, toPerson, clientSettings_NotificationStepId)
        {
