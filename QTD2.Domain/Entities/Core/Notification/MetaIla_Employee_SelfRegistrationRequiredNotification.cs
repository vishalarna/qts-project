...
{
    public class MetaIla_Employee_SelfRegistrationRequiredNotification : Notification
    {
        ...
        public MetaIla_Employee_SelfRegistrationRequiredNotification() { }

        public MetaIla_Employee_SelfRegistrationRequiredNotification(DateTime dueDate, 
            int? metaILA_Employee_MemberLinkFufillmentId, 
            int nextMeta_ILAMembers_LinkId, 
            int employeeId,
            int toPerson, int clientSettings_NotificationStepId) : base(dueDate, toPerson, clientSettings_NotificationStepId)
        {
