...
{
    public class MetaIla_Employee_RegistrationRequiredNotification : Notification
    {
        ...
        public MetaIla_Employee_RegistrationRequiredNotification() { }

        public MetaIla_Employee_RegistrationRequiredNotification(DateTime dueDate, int? metaILA_Employee_MemberLinkFufillmentId, int nextMeta_ILAMembers_LinkId, int employeeId, int toPerson, int clientSettings_NotificationStepId) : base(dueDate, toPerson, clientSettings_NotificationStepId)
        {
