...
namespace QTD2.Data.Initialization.QTDContext
{
    ...
    {
        protected void UAT_AddInstructor_Category()
        {
        ...
        protected void UAT_AddInstructorTable()
        {
        ...
        protected void UAT_AddPersonsTable()
        {
            ...
            _migrationBuilder.InsertData(
                ...
                values: toRectangular(persons.Select(r => new object[] { r.FirstName, r.LastName, r.Username, r.Active, false }).ToArray()));
        }

        protected void UAT_AddEmployeeTable()
        {
        ...
        protected void UAT_AddCertificationsHistoryTable()
        {
        ...
        protected void UAT_AddEmployeeCertificationsTable()
        {
        ...
        protected void UAT_AddEmployeePositionTable()
        {
            ...
            _migrationBuilder.InsertData(
                ...
                columns: new[] { "EmployeeId", "PositionId", "StartDate", "EndDate", "Trainee", "IsSignificant", "Active" },
                values: toRectangular(objs.Select(r => new object[] { r.EmployeeId, r.PositionId, DateOnly.FromDateTime(DateTime.Now).ToDateTime(TimeOnly.MinValue), DateOnly.FromDateTime(DateTime.Now).ToDateTime(TimeOnly.MinValue), r.Trainee, true, true }).ToArray()));
        }

        protected void UAT_AddPositionTable()
        {
        ...
        protected void UAT_AddClientUsers()
        {
            string jsonString = System.IO.File.ReadAllText(_path + "\\persons.json");
            List<Person> persons = JsonSerializer.Deserialize<List<Person>>(jsonString);
        ...
        protected void UAT_AddVersion_EmployeeTable()
        {
            _migrationBuilder.InsertData(
        ...
        protected void UAT_AddEmployeeOrganizationTable()
        {
        ...
        protected void UAT_AddOrganizationTable()
        {
        ...
        protected void UAT_AddTrainingProgramTable()
        {
        }

        protected void UAT_AddCertifyingBodyTable()
        {
            _migrationBuilder.InsertData(
        ...
        protected void UAT_AddCertificationTable()
        {
            _migrationBuilder.InsertData(
        ...
        protected void UAT_AddDutyAreaTable()
        {
        ...
        protected void UAT_AddSubdutyAreaTable()
        {
        ...
        protected void UAT_AddTaskTable()
        {
        ...
        protected void UAT_AddEnablingObjectiveTable()
        {
        ...
        protected void UAT_AddEnablingObjective_TopicTable()
        {
        ...
        protected void UAT_AddEnablingObjective_CategoryTable()
        {
        ...
        protected void UAT_AddEnablingObjective_SubCategoryTable()
        {
        ...
        protected void UAT_AddProcedure_IssuingAuthorityTable()
        {
        ...
        protected void UAT_AddProcedureTable()
        {
        ...
        protected void UAT_AddSaftyHazard_categoryTable()
        {
        ...
        protected void UAT_AddSaftyHazardTable()
        {
        ...
        protected void UAT_AddSaftyHazard_ControlTable()
        {
            //_migrationBuilder.InsertData(
        ...
        protected void UAT_AddSaftyHazard_AbatementTable()
        {
            //_migrationBuilder.InsertData(
        ...
        protected void UAT_AddProcedure_SaftyHazard_LinkTable()
        {
        }

        protected void UAT_AddProcedure_EnablingObjective_LinkTable()
        {
        }

        protected void UAT_AddEnablingObjective_SaftyHazard_LinkTable()
        {
        }

        protected void UAT_AddEnablingObjective_Procedure_LinkTable()
        {
        }

        protected void UAT_AddTask_EnablingObjective_LinkTable()
        {
        }

        protected void UAT_AddTask_Procedure_LinkTable()
        {
        }

        protected void UAT_AddTask_SaftyHazard_LinkTable()
        {
        }

        protected void UAT_AddTask_StepTable()
        {
            //_migrationBuilder.InsertData(
            //   table: "Task_Steps",
        ...
        protected void UAT_AddTask_ToolTable()
        {
            //_migrationBuilder.InsertData(
            //   table: "Task_Tools",
        ...
        protected void UAT_AddToolGroupsTable()
        {
            //_migrationBuilder.InsertData(
            //  table: "ToolGroups",
        ...
        protected void UAT_AddToolTable()
        {
            //_migrationBuilder.InsertData(
            //     table: "Tools",
        ...
        protected void UAT_AddToolGroup_ToolsTable()
        {
            //_migrationBuilder.InsertData(
        ...
        protected void UAT_AddVersion_TaskTable()
        {
        }

        protected void UAT_AddVersion_Task_StepTable()
        {
        }

        protected void UAT_AddVersion_Task_QuestionTable()
        {
        }

        protected void UAT_AddVersion_ProcedureTable()
        {
        }

        protected void UAT_AddVersion_Task_Procedure_LinkTable()
        {
        }

        protected void UAT_AddVersion_ToolTable()
        {
        }

        protected void UAT_AddVersion_Task_Tool_LinkTable()
        {
        }

        protected void UAT_AddVersion_Procedure_Tool_LinkTable()
        {
        }

        protected void UAT_AddVersion_Task_EnablingObjective_LinkTable()
        {
        }

        protected void UAT_AddVersion_EnablingObjective_Tool_LinkTable()
        {
        }

        protected void UAT_AddVersion_SaftyHazardTable()
        {
        }

        protected void UAT_AddVersion_SaftyHazard_AbatementTable()
        {
        }

        protected void UAT_AddVersion_SaftyHazard_ControlTable()
        {
        }

        protected void UAT_AddVersion_Task_SaftyHazard_LinkTable()
        {
        }

        protected void UAT_AddVersion_Procedure_SaftyHazard_LinkTable()
        {
        }

        protected void UAT_AddVersion_EnablingObjective_SaftyHazard_LinkTable()
        {
        }

        protected void UAT_AddVersion_EnablingObjectiveTable()
        {
        }

        protected void UAT_AddVersion_EnablingObjective_Procedure_LinkTable()
        {
        }

        protected void UAT_AddVersion_Procedure_EnablingObjective_LinkTable()
        {
        }

        protected void UAT_AddEmployee_TaskTable()
        {
            ...
            _migrationBuilder.InsertData(
                ...
                columns: new[] { "TaskId", "EmployeeId", "MajorVersion", "MinorVersion", "Active" },
                values: toRectangular(objs.Select(r => new object[] { r.TaskId, r.EmployeeId, r.MajorVersion, r.MinorVersion, true }).ToArray()));
        }

        protected void UAT_AddTimesheetTable()
        {
        }

        protected void UAT_AddTask_QuestionTable()
        {
        }

        protected void UAT_AddTask_PositionTable()
        {
            ...
            _migrationBuilder.InsertData(
                ...
                columns: new[] { "TaskId", "PositionId", "Active" },
                values: toRectangular(objs.Select(r => new object[] { r.TaskId, r.PositionId, true }).ToArray()));

        }

        protected void UAT_AddProviderLevelTable()
        {
            _migrationBuilder.InsertData(
        ...
        protected void UAT_AddProviderTable()
        {
        ...
        protected void UAT_AddILA_TopicTable()
        {
        }

        protected void UAT_AddILA_PreRequisite_LinksTable()
        {
        ...
        protected void UAT_AddILA_UploadsTable()
        {
        ...
        protected void UAT_AddILA_NERCAudience_LinksTable()
        {
        ...
        protected void UAT_AddDeliveryMethodTable()
        {
            _migrationBuilder.InsertData(
                 table: "DeliveryMethods",
                 columns: new[] { "Name", "DisplayName", "IsNerc", "CreatorIlaId", "Active", "Deleted" },
                 values: new object[,]
                   {
                    { "Backup Drill Facility", "Backup Drill Facility", false, 0, true, false },
                    { "Classroom", "Classroom", false, 0,  true, false},
                    { "Computer Based Training (CBT)", "Computer Based Training (CBT)", false, 0, true, false },
                    { "External Conference/Seminar/Workshop", "External Conference/Seminar/Workshop", false, 0, true, false },
                    { "Field Visit", "Field Visit", false, 0, true, false },
                    { "On-the-Job Training (OJT)", "On-the-Job Training (OJT)", false, 0, true, false },
                    { "One-on-One Training", "One-on-One Training", false, 0, true, false },
                    { "Self-Study (e.g., paperbased)", "Self-Study (e.g., paperbased)", false, 0, true, false },
                    { "Simulator Training", "Simulator Training", false, 0, true, false },
                    { "Table Top Simulation", "Table Top Simulation", false, 0, true, false },
                    { "Task Qualification", "Task Qualification", false, 0, true, false },
                    { "Vendor Supplied Training", "Vendor Supplied Training", false, 0, true, false },
                    { "Virtual Instructor Led Training", "Virtual Instructor Led Training", false, 0, true, false },
                    { "Workshop", "Workshop", true, 0, true, false },
                    { "Traditional Classroom Activities", "Traditional Classroom Activities", true, 0, true, false },
                    { "Conferences", "Conferences", true, 0, true, false },
                    { "Seminars", "Seminars", true, 0, true, false },
                    { "In-house training curricula", "In-house training curricula", true, 0, true, false },
                    { "Structured self-study activities", "Structured self-study activities", true, 0, true, false },
                    { "Online and distance - learning activities", "Online and distance - learning activities", true, 0, true, false },
                    { "Operator Training Simulations", "Operator Training Simulations", true, 0, true, false },
                    { "Computer- based training activities", "Computer- based training activities", true, 0, true, false },
                   });
        }

        protected void UAT_AddTrainingTopicTable()
        {
            _migrationBuilder.InsertData(
        ...
        protected void UAT_AddNercStandardTable()
        {
            _migrationBuilder.InsertData(
                       table: "NercStandards",
        ...
        protected void UAT_AddNercStandardMemberTable()
        {
            _migrationBuilder.InsertData(
        ...
        protected void UAT_AddTraineeEvaluationTypeTable()
        {
            _migrationBuilder.InsertData(
        ...
        protected void UAT_AddMetaILATable()
        {
        }

        protected void UAT_AddSegmentTable()
        {
        }

        protected void UAT_AddAssessmentToolTable()
        {
        }

        protected void UAT_AddRR_IssuingAuthorityTable()
        {
        ...
        protected void UAT_AddRegulatoryRequirementTable()
        {
        ...
        protected void UAT_AddRR_SH_LinkTable()
        {
        }

        protected void UAT_AddILATable()
        {
            string jsonString = System.IO.File.ReadAllText(_path + "\\ila.json");
            List<ILA> objs = JsonSerializer.Deserialize<List<ILA>>(jsonString);
            _migrationBuilder.InsertData(
                table: "ILAs",
                columns: new[] { "Name", "Description", "ProviderId", "IsSelfPaced", "IsOptional", "IsPublished", "HasPilotData", "IsProgramManual", "EffectiveDate", "ApprovalDate", "SubmissionDate", "ExpirationDate", "Deleted", "Active", "CBTRequiredForCourse" },
                values: toRectangular(objs.Select(r => new object[] { r.Name, r.Description, r.ProviderId, r.IsSelfPaced, r.IsOptional, r.IsPublished, r.HasPilotData, r.IsProgramManual, r.EffectiveDate, DateOnly.FromDateTime(DateTime.Now).ToDateTime(TimeOnly.MinValue), DateOnly.FromDateTime(DateTime.Now).ToDateTime(TimeOnly.MinValue), DateOnly.FromDateTime(DateTime.Now).ToDateTime(TimeOnly.MinValue), false, true, r.CBTRequiredForCourse }).ToArray()));
        }


        protected void UAT_AddTrainingTopic_CategoryTable()
        {
            _migrationBuilder.InsertData(
        ...
        protected void UAT_AddNERCTargetAudienceTable()
        {
            _migrationBuilder.InsertData(
        ...
        protected void UAT_AddRatingScaleTable()
        {
        ...
        protected void UAT_AddStudentEvaluationTable()
        {
        }

        protected void UAT_AddStudentEvaluationAvailabilityTable()
        {
            _migrationBuilder.InsertData(
        ...
        protected void UAT_AddILA_NERCAudience_LinkTable()
        {
        }

        protected void UAT_AddStudentEvaluationFormsTable()
        {
        ...
        protected void UAT_AddCoverSheetTypeTable()
        {
        }

        protected void UAT_AddStudentEvaluationQuestionTable()
        {
        ...
        protected void UAT_AddCollaboratorInvitationTable()
        {
        }

        protected void UAT_AddCoversheetTable()
        {
        }

        protected void UAT_AddCustomEnablingObjectiveTable()
        {
        }

        protected void UAT_AddStudentEvaluationAudienceTable()
        {
            _migrationBuilder.InsertData(
        ...
        protected void UAT_AddTaxonomyLevelTable()
        {
            _migrationBuilder.InsertData(
        ...
        protected void UAT_AddTestStatusTable()
        {
            _migrationBuilder.InsertData(
                   table: "TestStatuses",
        ...
        protected void UAT_AddTestTable()
        {
        }

        protected void UAT_AddTestTypeTable()
        {
            _migrationBuilder.InsertData(
                    table: "TestTypes",
                    columns: new[] { "Description", "Active" },
        ...
        protected void UAT_AddTestSettingTable()
        {
            _migrationBuilder.InsertData(
                     table: "TestSettings",
        ...
        protected void UAT_AddTestItemTypeTable()
        {
            _migrationBuilder.InsertData(
                    table: "TestItemTypes",
                    columns: new[] { "Description", "Active" },
        ...
        protected void UAT_AddTestItemTable()
        {
        }

        protected void UAT_AddILATraineeEvaluationTable()
        {
        }

        protected void UAT_AddTestItemMatchTable()
        {
        }

        protected void UAT_AddTestItemMCQTable()
        {
        }

        protected void UAT_AddTestItemTrueFalseTable()
        {
        }

        protected void UAT_AddTestItemFillBlankTable()
        {
        }

        protected void UAT_AddTestItemShortAnswerTable()
        {
        }

        protected void UAT_AddDiscussionQuestionTable()
        {
        }

        protected void UAT_AddToolCategoryTable()
        {
            _migrationBuilder.InsertData(
        ...
        protected void UAT_AddSimulatorScenarioDifficultyLevelTable()
        {
            _migrationBuilder.InsertData(
        ...
        protected void UAT_AddSimulationScenarioSpecLookUpTable()
        {
        }

        protected void UAT_AddSimulatorScenarioTable()
        {
        }

        protected void UAT_AddTrainingGroup_CategoryTable()
        {
            _migrationBuilder.InsertData(
        ...
        protected void UAT_AddTrainingGroupTable()
        {
            _migrationBuilder.InsertData(
        ...
        protected void UAT_AddTask_TrainingGroupTable()
        {

        }

        protected void UAT_AddActivityNotificationTable()
        {
            _migrationBuilder.InsertData(
        ...
        protected void UAT_AddVersion_TrainingGroupTable()
        {

        }

        protected void UAT_AddSettings_EmailNotifications()
        {
        ...
        protected void UAT_AddTrainingProgramTypeTable()
        {
            _migrationBuilder.InsertData(
        ...
        protected void UAT_UpdateTrainingProgramTypeTable_VersionIsYear()
        {
        ...
        protected void UAT_AddRatingScaleNTable()
        {
            _migrationBuilder.InsertData(
                 table: "RatingScaleNs",
        ...
        protected void UAT_RatingScaleExpandedTable()
        {
            _migrationBuilder.InsertData(
        ...
        protected void UAT_AddTrainingPrograms_ILA_LinksTable() { }
        protected void UAT_AddClassSchedule_Roster_StatusesTable()
        {
            _migrationBuilder.InsertData(
        ...
        protected void UAT_AddClassScheduleTable()
        {
            ...
            //    columns: new[] { "Id", "IsRecurring", "ILAID", "StartDateTime", "EndDateTime", "Deleted", "Active" },
            //    values: toRectangular(objs.Select(r => new object[] { r.Id, r.IsRecurring, r.ILAID, r.StartDateTime, r.EndDateTime, r.Deleted, r.Active }).ToArray()));
        }

        protected void UAT_AddEvaluationMethodTable()
        {
            _migrationBuilder.InsertData(
        ...
        protected void UAT_AddTaskQualificationStatusTable()
        {
            _migrationBuilder.InsertData(
        ...
        protected void UAT_AddTaskQualification_Evaluator_LinksTable()
        {
        ...
        protected void UAT_AddDatabaseSettings()
        {
            ...
            for (int i = 0; i < clientUserSettingsDashboardSetting.Count() / 1000; i++)
            {
                _migrationBuilder.InsertData(
                     table: "ClientUserSettings_DashboardSettings",
                     columns: new[] { "ClientUserId", "DashboardSettingId", "Enabled", "Active" },
                     values: toRectangular(clientUserSettingsDashboardSetting.Skip(i * 1000).Take(1000).Select(r => new object[] { r.ClientUserId, r.DashboardSettingId, r.Enabled, true }).ToArray()));
        ...
        protected void UAT_AddIDP_ReviewStatusTable()
        {
            _migrationBuilder.InsertData(
        ...
        protected void UAT_AddIDP_ReviewTable()
        {
        ...
        protected void UAT_AddMetaILAConfigurationPublishOption()
        {
            _migrationBuilder.InsertData(
        ...
        protected void UAT_AddMetaILAAssessment()
        {
            _migrationBuilder.InsertData(
        ...
        protected void UAT_AddMetaILA_Status()
        {
            _migrationBuilder.InsertData(
        ...
        protected void UAT_AddLocationCategories()
        {
        ...
        protected void UAT_AddLocation()
        {
        ...
        protected void UAT_AddPosition_TasksTable()
        {
        ...
        protected void UAT_AddDocumentTypesTable()
        {
            _migrationBuilder.InsertData(
                table: "DocumentTypes",
        ...
        protected void UAT_AddInstructorWorkbook()
        {
            _migrationBuilder.InsertData(
        ...
        protected void UAT_UpdateMetaILAConfigurationPublishOption()
        {
            _migrationBuilder.UpdateData(
                table: "MetaILAConfigurationPublishOptions",
        ...
        protected void UAT_UpdateDocumentTypeTable()
        {
            _migrationBuilder.InsertData(
                table: "DocumentTypes",
                columns: new[] { "Name", "LinkedDataType", "Deleted", "Active" },
        ...
        protected void UAT_AddMetaIlaEmployees()
        {
            _migrationBuilder.InsertData(
               table: "ClientSettings_Notifications",
...
Thank you.", 1, false, true }
        ...
        protected void UAT_AddMetaIlaTestType()
        {
            _migrationBuilder.InsertData(
                   table: "TestTypes",
                   columns: new[] { "Description", "Active", "Deleted" },
        ...
        protected void UAT_UpdateClientSettings_GeneralSettings_DateFormat()
        {
            _migrationBuilder.UpdateData(
                table: "ClientSettings_GeneralSettings",
        ...
        protected void UAT_UpdateTaskReQualificationEmpSignOffData()
        {
            //_migrationBuilder.UpdateData(
        ...
        protected void UAT_AddClassSchedule_SelfRegistrationOptionsData()
        {
        ...
        protected void UAT_ModifySelfRegistrationOptions()
        {
        ...
        protected void UAT_UpdateCertifyingBodiesTableData()
        {
            _migrationBuilder.UpdateData(
            table: "CertifyingBodies",
            keyColumn: "Name",
        ...
        protected void UAT_ModifyClientSettingNotificationTemplates()
        {
            string clientSettingsJsonString = System.IO.File.ReadAllText(_path + "\\clientsettings_notifications.json");
            List<ClientSettings_Notification> clientSettings = JsonSerializer.Deserialize<List<ClientSettings_Notification>>(clientSettingsJsonString);
        ...
        protected void UAT_UpdateILATaskObjectiveLinksSequenceNumber()
        {
        ...
        protected void UAT_AddDIFSurvey_DevStatus()
        {
        ...
        protected void UAT_AddDIFSurvey_Employee_Status()
        {
        ...
        protected void UAT_AddDIFSurvey_Task_Status()
        {
        ...
        protected void UAT_AddDIFSurvey_Task_TrainingFrequency()
        {
        ...
        protected void UAT_AddDIFSurvey()
        {
        }

        protected void UAT_AddDIFSurvey_Employee()
        {
        }

        protected void UAT_AddDIFSurvey_Task()
        {
        }

        protected void UAT_AddDIFSurvey_Employee_Response()
        {
        }

        protected void UAT_AddEmailNotification_AdminEmployeePortalCompletions()
        {
            _migrationBuilder.InsertData(
              table: "ClientSettings_Notifications",
              columns: new[] { "Name", "Enabled", "TimingText", "Deleted", "Active" },
        ...
        protected void UAT_UpdateInstructorWorkbook_ILADesign_Segments()
        {
            _migrationBuilder.Sql(@"UPDATE [dbo].[InstructorWorkbook_ILADesign_Segments]
            SET SegmentTitle = CONCAT('Segment', Id)");
        }

        protected void UAT_AddClientSettings_Feature()
        {
            _migrationBuilder.InsertData(
        ...
        protected void UAT_UpdateClientSettings_LabelReplacementsEnhanced()
        {
            _migrationBuilder.InsertData(
             table: "ClientSettings_LabelReplacements",
        ...
        protected void UAT_Update_TblClientSettings_GeneralSettings()
        {
            _migrationBuilder.Sql("UPDATE ClientSettings_GeneralSettings SET CompanySpecificCoursePassingScore = '65'");
        }
        protected void UAT_UpdateActivityNotificationsTable()
        {
        ...
        protected void UAT_AddAdminEmailNotificationStepsSettings()
        {
            _migrationBuilder.InsertData(
              table: "ClientSettings_Notification_Step_AvailableCustomSettings",
              columns: new[] { "ClientSettingsNotificationStepId", "Setting", "Active" },
        ...
        protected void UAT_UpdateAdminEmailNotificationTimingText()
        {
            _migrationBuilder.UpdateData(
            table: "ClientSettings_Notifications",
        ...
        protected void UAT_UpdateClientSettingsNotification_Admin()
        {
            _migrationBuilder.UpdateData(
            table: "ClientSettings_Notifications",
             keyColumns: new[] { "Id", "Name" },
        ...
        protected void UAT_UpdateAdminEmailNotificationStepsSettings()
        {
            _migrationBuilder.UpdateData(
             table: "ClientSettings_Notification_Steps",
        ...
        protected void UAT_AddEmpSettingsReleaseTypes()
        {
        ...
        protected void UAT_UpdateEmpSettingsReleaseTypes()
        {
        ...
        protected void UAT_UpdateEmailNotificationTemplate()
        {
        ...
        protected void UAT_AddTaskListReview_Type()
        {
        ...
        protected void UAT_AddTaskListReview_Status()
        {
        ...
        protected void UAT_AddTaskReview_Status()
        {
        ...
        protected void UAT_AddTaskReview_Finding()
        {
        ...
        protected void UAT_AddActionItem_Priority()
        {
        ...
        protected void UAT_AddActionItem_OperationTypes()
        {
        ...
        protected void UAT_AddActionItem_OperationType_Links()
        {
        ...
        protected void UAT_AddTaskListReviewDocumentType()
        {
            _migrationBuilder.InsertData(
                table: "DocumentTypes",
                columns: new[] { "Name", "LinkedDataType", "Deleted", "Active" },
        ...
        protected void UAT_AddSimulatorScenarioDifficulty()
        {
        ...
        protected void UAT_AddSimulatorScenario_CollaboratorPermission()
        {
        ...
        protected void UAT_AddSimulatorScenario_Status()
        {
            _migrationBuilder.InsertData(
        ...
        protected void UAT_AddEmailNotification_SimulatorScenarioCollaboration()
        {
            _migrationBuilder.InsertData(
              table: "ClientSettings_Notifications",
              columns: new[] { "Name", "Enabled", "TimingText", "Deleted", "Active" },
        ...
        protected void UAT_CopySimulatorScenarioOldToNew()
        {
            _migrationBuilder.Sql(@"
 ...
                WHERE SimulatorScenarios.Title IS NULL OR SimulatorScenarios.Title = '';
        ...
        protected void UAT_AddTrainingIssue_Status()
        {
            _migrationBuilder.InsertData(
        ...
        protected void UAT_AddTrainingIssue_Severity()
        {
            _migrationBuilder.InsertData(
        ...
        protected void UAT_AddTrainingIssue_DriverType()
        {
            _migrationBuilder.InsertData(
        ...
        protected void UAT_AddTrainingIssue_DriverSubType()
        {
            _migrationBuilder.InsertData(
        ...
        protected void UAT_AddTrainingIssue_ActionItemPriority()
        {
            _migrationBuilder.InsertData(
        ...
        protected void UAT_AddTrainingIssue_ActionItemStatus()
        {
            _migrationBuilder.InsertData(
        ...
        protected void UAT_UpdateDuplicateInstructorEmails()
        {
            _migrationBuilder.Sql(@"
        ...
        protected void UAT_UpdateStudentEvaluation()
        {
        ...
        protected void UAT_UpdateEvaluationReleaseEMPSettings()
        {
        ...
        protected void UAT_UpdateRecord_IlaStudentEvalLinks()
        {
        ...
        protected void UAT_UpdateVersionNumberinExistingVersionILAs()
        {
            _migrationBuilder.Sql(@"
				                    UPDATE main
        ...
        protected void UAT_AddData_EmployeeHistoryTableandReport()
        {
        ...
        protected void UAT_UpdateVersionILAsToPublishedStateBasedOnEffectiveDate()
        {
            _migrationBuilder.Sql(@"
        ...
        protected void UAT_AddTableData_ClassScheduleEmpSettings()
        {
        ...
        protected void UAT_AddTableData_ClassScheduleTQEMPSettings()
        {
        ...
        protected void UAT_ApplyDatabaseUpdateScripts()
        {
            _migrationBuilder.Sql(@"
        ...
        protected void UAT_UpdateDocumentTypeForCourseCompletionInfo()
        {
            _migrationBuilder.UpdateData(
               table: "DocumentTypes",
        ...
        protected void UAT_UpdateLaunchLinkInCbtScormRegistration()
        {
            _migrationBuilder.Sql(@"
        ...
        protected void UAT_AddScormRegistrationsForActiveClassScheduleEmployees()
        {
            _migrationBuilder.Sql(@"
                with CTE_DATA as (
                        select  
        ...
        protected void UAT_UpdateInactiveScormRegistrations()
        {
        ...
        protected void UAT_UpdateApiRegistrationIdsForScormRegistrationsAndScormApiRegToLearner()
        {
            _migrationBuilder.Sql(@"
        ...
        protected void UAT_UpdateTaskQualificationsLinkedToDeletedTasks()
        {
            _migrationBuilder.Sql(@"
        ...
        protected void UAT_UpdateTaskActiveStatusFromHistory()
        {
            _migrationBuilder.Sql(@"
        ...
        protected void UAT_UpdateDocumentTypesTable_Tool()
        {
            _migrationBuilder.UpdateData(
                table: "DocumentTypes",
                keyColumns: new[] { "Id", "Name" },
        ...
        protected void UAT_UpdateILACertificationLinksForDeletedCertifications()
        {
        ...
        protected void UAT_UpdateDeletedTaskQualificationEvaluatorLinksForDeletedEmployees()
        {
        ...
        protected void UAT_MarkDeletedPositionTasksBasedOnTasks()
        {
        ...
        protected void UAT_UpdateSegmentObjectiveLinksData()
        {
        ...
        protected void UAT_AddTrainingTopicsTableData()
        {
            _migrationBuilder.InsertData(
                    table: "TrainingTopics",
                    columns: new[] { "TrainingTopic_CategoryId", "Name", "Active" },
        ...
        protected void UAT_AddData_AdminEMPCompletionNotificationAndSettings()
        {
        ...
        protected void UAT_NotificationTemplateAdjustments()
        {
            _migrationBuilder.Sql(@"update  [dbo].[ClientSettings_Notification_Steps]
                                      set template = '<p>Hello @Model.EmployeeFirstName @Model.EmployeeLastName,</p> <p> You have been assigned to complete a Task Qualification as part of your position specific training program. An evaluator has been assigned to sign - off on this task qualification.This will be completed using the Employee Portal(EMP). Please review the table below for further details. To help you prepare for the task qualification, the task(s) below are available in a read - only format in EMP.</p><figure class=""table""><table><tbody><tr><td>Task #</td><td>@Model.TaskNumber</td></tr><tr><td>Task Statement</td><td>@Model.TaskStatement</td></tr><tr><td>Evaluator Name</td><td>@Model.EvaluatorName</td></tr></tbody></table></figure><p>If for any reason you cannot complete the assigned Task Qualification, notify your Task Qualification Evaluator and/or Training Administrator as soon as possible.</p><p> Thank you!</p>'

                                      where ClientSettingsNotificationId = (select id from ClientSettings_Notifications where name = 'EMP Task Qualification - Trainee')"
           );
        }

        protected void UAT_Update_NotificationTemplate()
        {
            _migrationBuilder.Sql(@"update  [dbo].[ClientSettings_Notification_Steps]
        ...
        protected void UAT_Update_NotifcationEmailTemplate()
        {
            _migrationBuilder.Sql(@"update  [dbo].[ClientSettings_Notification_Steps]
        ...
        protected void UAT_UpdateTaskEoLinksOfDeletedEO()
        {
        ...
        protected void UAT_Update_NotificationEmailTemplatesWithUsing()
        {
            _migrationBuilder.Sql(@"update  [dbo].[ClientSettings_Notification_Steps]
                                 set template = '@using QTD2.Infrastructure.ExtensionMethods;<p>Hello @Model.EmployeeFirstName @Model.EmployeeLastName,</p><p>Your immediate attention is required. This is an urgent reminder from the Training Department that your @Model.CertificateName certificate @Model.CertificateNumber will expire in @Model.DaysUntilCertificationExpiration days. Your expiration date is @Model.CertificateExpirationDate.ConvertWithTimeZoneName(Model.DefaultTimeZoneId). To date, we have not received a copy of your updated @Model.CertificateName certificate.</p> <p>After multiple notifications regarding the renewal of your @Model.CertificateName credential, your management has also received a copy of this notification. You and your management will continue to receive daily reminders until the System Operations Training Team receives an updated copy of your @Model.CertificateName certificate.</p> <p>If you received this message in error or are no longer maintaining this certificate, we ask that you let us know so we can update our records. If you have any questions,please reach out to your Training Administrator.</p><p>Thank you!</p>'
        ...
        protected void UAT_UndeleteCompletedClassesAndClearIDPInfo()
        {
        ...
        protected void UAT_UpdateEMPPretestNotificationEmailTemplate()
        {
            _migrationBuilder.Sql(@"update  [dbo].[ClientSettings_Notification_Steps]
                                 set template = '@using QTD2.Infrastructure.ExtensionMethods;<p>Hello @Model.EmployeeFirstName @Model.EmployeeLastName,</p><p>You have been enrolled in a course which requires you to complete a pretest prior to the course start date. You can access the pretest through the Employee Portal (EMP). Please review the table below for further details.</p><figure class=""table""><table><tr><td>Course Title</td><td>@Model.CourseTitle</td></tr><tr><td>Instructor/Location</td><td>@Model.Instructor/@Model.Location</td></tr><tr><td>Class Dates</td><td>@Model.ClassStartDate.ConvertWithTimeZoneName(Model.DefaultTimeZoneId) - @Model.ClassEndDate.ConvertWithTimeZoneName(Model.DefaultTimeZoneId)</td></tr><tr><td>Pretest ID/Name</td><td>@Model.PretestId/@Model.PretestTitle</td></tr><tr><td>Pretest Available Date</td><td>@Model.PretestAvailableDate.ConvertWithTimeZoneName(Model.DefaultTimeZoneId)</td></tr><tr><td>Pretest Due Date</td><td>@Model.ClassStartDate.ConvertWithTimeZoneName(Model.DefaultTimeZoneId)</td></tr></table></figure><p>If you are unable to complete the pretest by the due date listed, contact your Training Administrator as soon as possible.</p><p>Thank you!</p>'
        ...
        protected void UAT_AddProfessionlaHoursToCertificationTable()
        {
            _migrationBuilder.InsertData(
            table: "Certifications",
        ...
        protected void UAT_UpdateVersionTasksIsInUseFlag()
        {
            _migrationBuilder.Sql(@"
        ...
        protected void UAT_MigrateDataFromProcedure_ILA_LinksToILA_Procedure_Links()
        {
        ...
        protected void UAT_AddNewReportFilters_AccordingToRRTTypes()
        {
            _migrationBuilder.InsertData(
        ...
        protected void UAT_UpdateReportFilters_ILAByProvider()
        {
            _migrationBuilder.DeleteData(
                table: "ReportSkeletonFilters",
        ...
        protected void UAT_UpdateReport_ILAByCompletionHistory()
        {
            _migrationBuilder.InsertData(
                table: "ReportSkeletonFilters",
        ...
        protected void UAT_UpdateReport_TaskByPosition()
        {
            _migrationBuilder.UpdateData(
            table: "ReportSkeletonFilters",
            keyColumns: new[] { "ReportSkeletonId", "Name" },
        ...
        protected void UAT_UpdateReport_TrainingIssueList()
        {
            _migrationBuilder.UpdateData(
        ...
        protected void UAT_AddReport_TrainingIssueDetails()
        {
            _migrationBuilder.InsertData(
               table: "ReportSkeletons",
        ...
        protected void UAT_AddReport_TrainingIssuesActionItems()
        {
            _migrationBuilder.InsertData(
               table: "ReportSkeletons",
               columns: new[] { "DefaultTitle", "Deleted", "Active" },
        ...
        protected void UAT_UpdateReport_TasksByTrainingTaskGroup()
        {
            _migrationBuilder.UpdateData(
            table: "ReportSkeletons",
        ...
        protected void UAT_AddNewReportFilters_EmployeeTrainingTowardNERCRecertification()
        {
            _migrationBuilder.InsertData(
                table: "ReportSkeletonFilters",
                columns: new[] { "ReportSkeletonId", "Name", "PropertyType", "ValueType", "MinOption", "MaxOption", "FilterOption", "Deleted", "Active", "DefaultValue", "MaxAllowedSelections" },
        ...
        protected void UAT_UpdateReportFilters_TasksByPosition()
        {
            _migrationBuilder.DeleteData(
                table: "ReportSkeletonFilters",
                keyColumns: new[] { "ReportSkeletonId", "Name" },
        ...
        protected void UAT_UpdateReportFilters_TrainingIssuesActionItems()
        {
            _migrationBuilder.UpdateData(
              table: "ReportSkeletonFilters",
              keyColumns: new[] { "ReportSkeletonId", "Name" },
        ...
        protected void UAT_AddClientSettings_Feature_PublicClasses()
        {
        ...
        protected void UAT_UpdateReportFilters_TrainingIssuesDetails()
        {
            _migrationBuilder.UpdateData(
              table: "ReportSkeletonFilters",
              keyColumns: new[] { "ReportSkeletonId", "Name" },
        ...
        protected void UAT_AddReportFilters_TrainingProgramCompletionHistory()
        {
            _migrationBuilder.InsertData(
             table: "ReportSkeletonFilters",
             columns: new[] { "ReportSkeletonId", "Name", "PropertyType", "ValueType", "MinOption", "MaxOption", "FilterOption", "Deleted", "Active", "DefaultValue" },
        ...
        protected void UAT_UpdateReportFilters_TrainingProgramCompletionHistory()
        {
            _migrationBuilder.DeleteData(
                 table: "ReportSkeletonFilters",
                 keyColumn: "Name",
        ...
        protected void UAT_AddDataToTrainingIssueActionItemsAssigneeName()
        {
            _migrationBuilder.Sql(@"UPDATE a
        ...
        protected void UAT_SeedInitialReportData()
        {
            _migrationBuilder.InsertData(
      ...
      values: new object[,]
      {
        ...
        protected void UAT_AddReport_TrainingProgramQualificationCard()
        {
            _migrationBuilder.InsertData(
               table: "ReportSkeletons",
               columns: new[] { "DefaultTitle", "Deleted", "Active" },
        ...
        protected void UAT_AddDataToClassScheduleTQEmpSettingsFromTQILAEmpSettings()
        {
        ...
        protected void UAT_UpdateTaskByPositionReportFilters()
        {
            _migrationBuilder.DeleteData(
                table: "ReportSkeletonFilters",
                keyColumns: new[] { "ReportSkeletonId", "Name" },
        ...
        protected void UAT_UpdateReportFilters_StudentEvaluationInstructorLed()
        {
            _migrationBuilder.InsertData(
             table: "ReportSkeletonFilters",
             columns: new[] { "ReportSkeletonId", "Name", "PropertyType", "ValueType", "MinOption", "MaxOption", "FilterOption", "Deleted", "Active", "DefaultValue", "MaxAllowedSelections" },
        ...
        protected void UAT_SeedDataToEnrolledPropertyOfMetaILAEmployees()
        {
            _migrationBuilder.Sql(@"UPDATE MetaILA_Employees SET Enrolled = 1");
        }

        protected void UAT_AddEmailNotification_PublicClassScheduleRequest()
        {
            _migrationBuilder.InsertData(
              table: "ClientSettings_Notifications",
              columns: new[] { "Name", "Enabled", "TimingText", "Deleted", "Active" },
        ...
        protected void UAT_UpdateEmailNotificationPublicClassScheduleRequestTemplate()
        {
            _migrationBuilder.UpdateData(
              table: "ClientSettings_Notification_Steps",
              keyColumns: new[] { "ClientSettingsNotificationId", "Order" },
        ...
        protected void UAT_UpdateReportFiltersForILACompletionHistory()
        {
            _migrationBuilder.Sql(@"
                UPDATE rf
        ...
        protected void UAT_AddReport_ProceduresByEnablingObjectives()
        {
            _migrationBuilder.InsertData(
               table: "ReportSkeletons",
               columns: new[] { "DefaultTitle", "Deleted", "Active" },
        ...
        protected void UAT_AddDataToTaskListReviewPositionLinksTable()
        {
        ...
        protected void UAT_UpdateInternalIdentifiersForCertifications()
        {
        ...
        protected void UAT_AddReportFilter_EmployeeDelinquencyReport()
        {
            _migrationBuilder.InsertData(
                table: "ReportSkeletonFilters",
                columns: new[] { "ReportSkeletonId", "Name", "PropertyType", "ValueType", "MinOption", "MaxOption", "FilterOption", "Deleted", "Active", "DefaultValue", "MaxAllowedSelections" },
        ...
        protected void UAT_UpdateReportSkeletonColumns_AnnualTaskListReviewReport()
        {
            _migrationBuilder.UpdateData(
            table: "ReportSkeletonColumns",
        ...
        protected void UAT_Seed_TaskReviewStatus_NotStarted()
        {
            _migrationBuilder.InsertData(
                table: "TaskReview_Status",
                columns: new[] { "Status", "Active" },
        ...
        protected void UAT_UpdateReportSkeletonFilter_TaskAndEnabingObjectiveByILA()
        {
            _migrationBuilder.UpdateData(
            table: "ReportSkeletonFilters",
            keyColumns: new[] { "ReportSkeletonId", "Name" },
        ...
        protected void UAT_MigrateReviewedByFromTrainerName()
        {
        ...
        protected void UAT_Update_ClientSettings_Notification_StepsTemplate()
        {
            _migrationBuilder.UpdateData(
                table: "ClientSettings_Notification_Steps",
                keyColumns: new[] { "ClientSettingsNotificationId", "Order" },
        ...
        protected void UAT_AddSkillQualificationStatusTable()
        {
            _migrationBuilder.InsertData(
