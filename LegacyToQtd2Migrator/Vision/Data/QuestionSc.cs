...
public partial class QuestionSc
{
    public decimal FkQuestion { get; set; }

    public decimal FkSubQuestion { get; set; }

    public decimal SubQuestionType { get; set; }
    ...
    public virtual Question FkSubQuestionNavigation { get; set; }
}
