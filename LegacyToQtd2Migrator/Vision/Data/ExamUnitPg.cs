...
public partial class ExamUnitPg
{
    ...
    public virtual Program FkExamUnitNavigation { get; set; }

    public virtual Developer FkExpiredByNavigation { get; set; }

    public virtual Program FkParentUnitNavigation { get; set; }

    public virtual ProgramImpl FkUnitImplNavigation { get; set; }

    public virtual Program FkUnitNavigation { get; set; }
}
