...
{
    public class OnSimulatorScenario_ILAs_UpdatedHandler : INotificationHandler<OnSimulatorScenario_ILAs_Updated>
    {
        ...
        public OnSimulatorScenario_ILAs_UpdatedHandler(Domain.Interfaces.Service.Core.ISimulatorScenarioService simulatorScenarioService,
        ...
        public async  Task Handle(OnSimulatorScenario_ILAs_Updated notification, CancellationToken cancellationToken)
        {
