...
namespace QTD2.Application.Interfaces.Services.Shared
{
    public interface ISimulatorScenarioService
    {
        ...
        public Task<SimulatorScenario_EventAndScript_VM> CreateEventAndScriptAsync(int id, SimulatorScenario_EventAndScript_VM options);
        public Task<SimulatorScenario_EventAndScript_VM> GetEventAndScriptAsync(int id, int EventAndScriptId);
        public System.Threading.Tasks.Task<SimulatorScenario_EventAndScript_VM> CopyEventAndScriptAsync(int id, int eventAndScriptId);
        public System.Threading.Tasks.Task DeleteEventAndScriptAsync(int id, int EventAndScriptId);
        public Task<SimulatorScenario_EventAndScript_VM> UpdateEventAndScriptAsync(int id, int EventAndScriptId, SimulatorScenario_EventAndScript_VM options);
        public System.Threading.Tasks.Task UpdateEventsAndScriptsOrderAsync(int id, SimulatorScenario_UpdateEventsAndScriptsOrder_VM options);
