...
@Component({
  selector: 'app-fly-panel-publish-training-program',
  templateUrl: './fly-panel-publish-training-program.component.html',
  styleUrls: ['./fly-panel-publish-training-program.component.scss']
})
export class FlyPanelPublishTrainingProgramComponent implements OnInit {
  constructor(
