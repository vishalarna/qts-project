...
@Component({
  selector: 'app-remainder-of-the-week',
  templateUrl: './remainder-of-the-week.component.html',
  styleUrls: ['./remainder-of-the-week.component.scss']
})
export class RemainderOfTheWeekComponent implements OnInit {
  ...
  async getEvents(){
    ...
    options.startDate = this.currentDate.toUTCString();
    options.endDate = this.endDate.toUTCString();
