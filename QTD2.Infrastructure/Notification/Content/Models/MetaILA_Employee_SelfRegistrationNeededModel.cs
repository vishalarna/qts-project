...
{
    public class MetaILA_Employee_SelfRegistrationNeededModel
    {
        ...
        public MetaILA_Employee_SelfRegistrationNeededModel(string employeeFirstName, string employeeLastName, string previousILATitle, string iLATitle, bool registrationsAvailable)
        {
