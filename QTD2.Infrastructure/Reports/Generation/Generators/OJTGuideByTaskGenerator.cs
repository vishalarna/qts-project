...
{
 public  class OJTGuideByTaskGenerator : ReportModelGenerator
    {
        ...
        public OJTGuideByTaskGenerator(
        ...
        public override async Task<IReportModel> GenerateModel(Report report)
        {
            ...
            var tasks = await getPositionTasksAsync(taskIds, isRRPositions, "All");
            ...
            return new OJTGuide(report.InternalReportTitle, templatePath, displayColumns, companyLogo, tasks, "Task", null, labelReplacement, defaultTimeZone);
        }
