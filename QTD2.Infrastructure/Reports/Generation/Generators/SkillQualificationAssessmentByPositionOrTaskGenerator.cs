...
{
    public class SkillQualificationAssessmentByPositionOrTaskGenerator : ReportModelGenerator
    {
        ...
        public SkillQualificationAssessmentByPositionOrTaskGenerator(
        ...
        {
            string templatePath = "SkillQualificationAssessmentByPositionOrTask.cshtml";
            var companyLogo = "";
            ...
            var distinctTaskIds = enablingObjectives.SelectMany(m=>m.Task_EnablingObjective_Links).Select(x => x.TaskId).Distinct().ToList();
