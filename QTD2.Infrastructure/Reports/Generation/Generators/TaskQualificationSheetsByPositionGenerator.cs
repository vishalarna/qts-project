...
{
  public  class TaskQualificationSheetsByPositionGenerator : ReportModelGenerator
    {
        ...
        public TaskQualificationSheetsByPositionGenerator(
        ...
        public override async Task<IReportModel> GenerateModel(Report report)
        {
            ...
            return new TaskQualificationSheets(report.InternalReportTitle, templatePath, displayColumns, companyLogo, tasks.ToList(), labelReplacement, "Position", defaultTimeZone);
        }
