...
namespace QTD2.Infrastructure.Model.SafetyHazard_Set
{
    public class SafetyHazard_SetCreateOptions
    {
        ...
        public string SafetyHzPPEText { get; set; }

        public string SafetyHzPPEFiles { get; set; }

        public string SafetyHzPPEImage { get; set; }
    }
}
