...
namespace QTD2.Infrastructure.Model.SimulatorScenario
{
    public class SimulatorScenario_Task_Criteria_By_Position_VM
    {
        ...
        public string TaskCriteria { get; set; }
        ...
        public SimulatorScenario_Task_Criteria_By_Position_VM(int? id, int taskId, string positionAbbreviation, string completeTaskNumber, string description, string criteria, string taskCriteria)
        {
            Id = id;
            TaskId = taskId;
